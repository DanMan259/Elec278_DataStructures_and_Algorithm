// AVL.H - ELEC278 Lab exercise 4 - Fall 2018
//
// HISTORY:
...
// Tree is basically pointer to top node in tree.  In other
...
// Get balance factor for a node - difference between left and right
// subtree heights
int		getBalanceFactor(Node* root);
// Calculate height of node, from the heights of the left and right
// subtrees.
